...
<table width="100%" border="" cellspacing="0" cellpadding="0" style="border:3px solid #FFFFFF">
  <tr>
    <td width="17%" align="center"><a href="#" class="style2 style5">Home</a></td>
    <td width="21%" align="center"><a href="#" class="style6">Profile</a></td>
    <td width="15%" align="center"><a href="#" class="style6">Forum</a></td>
    <td width="14%" align="center"><a href="#" class="style6">Messages</a></td>
    <td width="15%" align="center"><a href="#" class="style6">Community</a></td>
    <td width="18%" align="center"><a href="#" class="style6">Logout</a></td>
  </tr>
</table>
<p>&nbsp;</p>
</body>
